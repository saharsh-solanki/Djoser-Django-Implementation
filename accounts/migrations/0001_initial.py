    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('USER', 'USER'), ('JOB_SEEKER', 'JOB_SEEKER'), ('COMPANY', 'COMPANY')], default='USER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('job_preference', models.CharField(choices=[('PART_TIME', 'PART_TIME'), ('FULL_TIME', 'FULL_TIME'), ('ANY', 'ANY')], default='ANY', max_length=20)),
